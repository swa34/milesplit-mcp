...
export function Component() {
  useSeo({ title: "404 — MileSplit MCP", description: NOT_FOUND.message });

  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] px-6 text-center">
      <div className="w-16 h-16 rounded-2xl bg-bg-secondary dark:bg-gray-800 flex items-center justify-center mb-6 text-3xl">
        {"//"}
      </div>
